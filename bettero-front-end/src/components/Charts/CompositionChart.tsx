...
interface CompositionChartProps {
  intervalType: string, 
  chartType: string,
  compositionObject: CategoryObject,
  onCategoryClick?: (e: MouseEvent<HTMLCanvasElement>, chartRef: any) => void
}

// chart indicating the composition percentage of this month  
export default function CompositionChart ({
  intervalType = "month", chartType = "regular", compositionObject, onCategoryClick,  
  ...
  return <Doughnut
    onClick={(e) => {
      e.preventDefault();
      if (!!onCategoryClick) onCategoryClick(e, chartRef);
