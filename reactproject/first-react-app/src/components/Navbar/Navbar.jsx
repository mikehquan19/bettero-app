...
import { faHouse, faChartSimple, faMoneyBill, 
    faArrowTrendUp, } from '@fortawesome/free-solid-svg-icons'
import LogoutForm from './../Forms/DeleteForms/LogoutForm/LogoutForm.jsx';
import './Navbar.css';
        ...
        <>
            <div className="navbar">
                ...
                <div className="options-wrapper">
                    ...
                    <Link to={`/summary`} style={commonStyle}
                        onMouseOver={(e) => {
                            e.target.style.backgroundColor = "rgba(0, 0, 0, 0.25)";
                        }}
                        onMouseOut={(e) => {
                    ...
                    <Link to={`/budget`} style={commonStyle}
                        onMouseOver={(e) => {
                            e.target.style.backgroundColor = "rgba(0, 0, 0, 0.25)";
                        }}
                        onMouseOut={(e) => {
                    ...
                    <Link to={`/investment`} style={commonStyle}
                        onMouseOver={(e) => {
                            e.target.style.backgroundColor = "rgba(0, 0, 0, 0.25)";
                        }}
                        onMouseOut={(e) => {
                    ...
                    <div style={commonStyle}
                        onMouseOver={(e) => e.target.style.backgroundColor = "rgba(0, 0, 0, 0.25)"}
            ...
            {logoutFormPresent && <LogoutForm 
                onHideForm={() => setLogoutFormPresent(!logoutFormPresent)} />}
        </>
    );
}
